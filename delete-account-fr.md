...
- **Journal de sécurité des détections de crise** : conservé 10 ans à compter de la détection (articles 9(2)(f) et 17(3)(e) du RGPD, défense d'un droit en justice ; l'analyse elle-même repose sur votre consentement explicite, article 9(2)(a)). L'extrait des propos est effacé au bout de 6 mois. Il contient uniquement : catégorie, extrait de 200 caractères maximum, langue, votre identifiant interne, l'identifiant de session, la méthode de détection, le mode d'usage, la date de la détection, et les indicateurs et horodatages d'affichage du message de soutien et des ressources d'urgence.
